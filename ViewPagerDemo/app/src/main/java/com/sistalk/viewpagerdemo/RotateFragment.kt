package com.sistalk.viewpagerdemo
...
import com.sistalk.viewpagerdemo.databinding.FragmentRotateBinding
...
class RotateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imageViewRotate.setOnClickListener {
            ObjectAnimator.ofFloat(it,"rotation",it.rotation+30.0f).start()
        }
    }
