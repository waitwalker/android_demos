...
import com.sistalk.videopager.databinding.FragmentVideoBinding
...
class VideoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        videoBinding = FragmentVideoBinding.inflate(inflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        videoBinding.videoViewPager.apply {
            adapter = object : FragmentStateAdapter(this@VideoFragment) {
                ...
                override fun createFragment(position: Int): Fragment {
                    return PlayerFragment(videoURLs[position])
                }
